...
import com.ibuxuan.commons.helpers.*
import com.ibuxuan.commons.helpers.MyContentProvider.Companion.COL_APP_ICON_COLOR
import com.ibuxuan.commons.helpers.MyContentProvider.Companion.COL_BACKGROUND_COLOR
import com.ibuxuan.commons.helpers.MyContentProvider.Companion.COL_LAST_UPDATED_TS
import com.ibuxuan.commons.helpers.MyContentProvider.Companion.COL_NAVIGATION_BAR_COLOR
import com.ibuxuan.commons.helpers.MyContentProvider.Companion.COL_PRIMARY_COLOR
import com.ibuxuan.commons.helpers.MyContentProvider.Companion.COL_TEXT_COLOR
import com.ibuxuan.commons.models.AlarmSound
import com.ibuxuan.commons.models.BlockedNumber
import com.ibuxuan.commons.models.SharedTheme
import com.ibuxuan.commons.views.*
import java.io.File
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.ibuxuan.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.isThankYouInstalled() = isPackageInstalled("com.ibuxuan.thankyou")

fun Context.isAProApp() = packageName.startsWith("com.ibuxuan.") && packageName.removeSuffix(".debug").endsWith(".pro")
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.ibuxuan."))
...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.ibuxuan.contacts")) {
        true
    } else if (packageName.startsWith("com.ibuxuan.contacts") && isQPlus()) {
