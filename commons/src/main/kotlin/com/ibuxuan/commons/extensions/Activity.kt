...
import com.ibuxuan.commons.models.*
import com.ibuxuan.commons.views.MyTextView
...
fun Activity.openPathIntent(path: String, forceChooser: Boolean, applicationId: String, forceMimeType: String = "", extras: HashMap<String, Boolean> = HashMap()) {
    ensureBackgroundThread {
        ...
        Intent().apply {
            ...
            if (applicationId == "com.ibuxuan.gallery.pro" || applicationId == "com.ibuxuan.gallery.pro.debug") {
