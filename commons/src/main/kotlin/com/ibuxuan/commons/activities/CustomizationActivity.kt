...
import com.ibuxuan.commons.dialogs.*
import com.ibuxuan.commons.extensions.*
import com.ibuxuan.commons.helpers.*
import com.ibuxuan.commons.models.MyTheme
import com.ibuxuan.commons.models.RadioItem
...
class CustomizationActivity : BaseSimpleActivity() {
    ...
    private fun pickPrimaryColor() {
        if (!packageName.startsWith("com.ibuxuan.", true) && baseConfig.appRunCount > 50) {
            finish()
            return
        }
