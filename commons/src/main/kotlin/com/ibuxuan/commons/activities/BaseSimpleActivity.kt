package com.ibuxuan.commons.activities
...
import com.ibuxuan.commons.asynctasks.CopyMoveTask
import com.ibuxuan.commons.dialogs.ConfirmationDialog
import com.ibuxuan.commons.dialogs.ExportSettingsDialog
import com.ibuxuan.commons.dialogs.FileConflictDialog
import com.ibuxuan.commons.dialogs.WritePermissionDialog
import com.ibuxuan.commons.extensions.*
import com.ibuxuan.commons.helpers.*
import com.ibuxuan.commons.interfaces.CopyMoveListener
import com.ibuxuan.commons.models.FAQItem
import com.ibuxuan.commons.models.FileDirItem
import java.io.File
...
abstract class BaseSimpleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!packageName.startsWith("com.ibuxuan.", true)) {
            if ((0..50).random() == 10 || baseConfig.appRunCount % 100 == 0) {
                val label = "You are using a fake version of the app. For your own safety download the original one from www.ibuxuan.com. Thanks"
    ...
    fun handleSAFDialog(path: String, callback: (success: Boolean) -> Unit): Boolean {
        return if (!packageName.startsWith("com.ibuxuan")) {
            callback(true)
            false
    ...
    private fun getExportSettingsFilename(): String {
        ...
        if (defaultFilename.isEmpty()) {
            val appName = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("com.ibuxuan.")
